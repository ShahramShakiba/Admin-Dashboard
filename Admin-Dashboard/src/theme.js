...
export const themeSettings = (mode) => {
  // return the theme based on the mode
...
/* ...(mode === 'dark' ? {} : {}) | spread Operator & Ternary Operator
- The spread operator allows us to expand an object or an array into individual elements. 

- In this case, it is used to conditionally merge color values based on the mode.
*/

/* revers color
- ctrl+p
- > sort lines descending
- then change the numbers manually 900 to 100 and so on
*/
